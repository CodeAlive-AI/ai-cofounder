...
> "Would this person be upset if [YOUR_PRODUCT] disappeared tomorrow?"
...
> "What is the smallest version of [YOUR_PRODUCT] they would pay for right now?"
...
- **meeting-prep** — pre-meeting intelligence briefing (the complement: before vs after)
- **pipeline-manager** — update prospect stage and notes after debrief
- **outreach-sender** — schedule follow-up outreach after discovery
- **hypothesis-tracker** — update hypotheses with conversation evidence
- **structured-log** — log debrief findings to daily memory
- **conducting-user-interviews** — preparing and planning interviews (before, not after)
- **founder-sales** — overall sales strategy and discovery techniques
