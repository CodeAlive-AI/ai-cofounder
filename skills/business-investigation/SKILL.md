...
2. **Gather data:**
   - PostHog: `posthog__query-generate-hogql-from-question question="..."` for quantitative data
...
1. **Name the cause specifically.** Not "bad marketing", but "positioning says 'AI platform' instead of a specific outcome we deliver for [your buyer]"
