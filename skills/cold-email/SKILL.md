---
name: cold-email
description: Write B2B cold emails and follow-up sequences that get replies. Use for "cold outreach," "prospecting email," "outbound email," "email to leads," "reach out to prospects," "sales email," "follow-up email," "nobody's replying to my emails," "how do I write a cold email." For sending and tracking outreach, see outreach-sender. For warm/lifecycle emails, see email-sequence. For sales strategy, see founder-sales.
metadata:
  version: 1.1.0
---
...
- [benchmarks.md](references/benchmarks.md) — Reply rates, conversion funnels, common mistakes
...
- **outreach-sender** — send orchestration: takes cold-email drafts → humanizer → approval → Gmail send
- **pipeline-manager** — pipeline context for personalization
- **founder-sales** — sales strategy and signal-based outreach workflow
- **humanizer** — polish emails to remove AI patterns (critical for credibility)
- **email-sequence** — warm/lifecycle sequences (not cold outreach)
- **prospect-demo** — personalized demo snippets to include in emails
