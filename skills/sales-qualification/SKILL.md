...
- **pipeline-manager** — FIT+INTENT+TIMING scoring and routing
- **founder-sales** — sales strategy for early-stage
- **enterprise-sales** — complex deal qualification
- **product-led-sales** — qualifying PLG-to-enterprise expansion
- **signal-scanner** — signal-based qualification triggers
