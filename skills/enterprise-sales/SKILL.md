...
- **founder-sales** — early-stage sales strategy
- **pipeline-manager** — pipeline tracking and scoring
- **meeting-prep** — pre-meeting intelligence briefings
- **prospect-demo** — personalized [YOUR_PRODUCT] demos for enterprise prospects
- **sales-qualification** — lead qualification
- **product-led-sales** — PLG-to-enterprise conversion
