...
### SaaS Sites ([YOUR_PRODUCT])
- Documentation pages need SEO too (docs.[your-domain].com)
- Feature pages should target "[solution] for [use case]"
- Comparison pages: "[YOUR_PRODUCT] vs [competitor]"
- Integration pages: "[YOUR_PRODUCT] + [tool] integration"
- Use case pages: "AI code review for [industry/team]"

### Key [YOUR_PRODUCT] SEO targets
- Landing: [your-domain].com
- Docs: docs.[your-domain].com
- Blog/posts: [your-domain].com/blog (if exists)

---

## Generative Engine Optimization (GEO)

Traditional SEO gets you into Google results. GEO gets you cited by AI answer engines (Perplexity, ChatGPT, Google AI Overviews, Gemini). For dev tools and similar B2B products, developers increasingly discover tools through AI search.

### Why GEO matters for [YOUR_PRODUCT]

Developers ask AI: "best tool for [YOUR_CORE_VALUE_PROP]," "how to give Copilot more codebase context," "MCP server for [YOUR_DOMAIN] search." If [YOUR_PRODUCT] content is structured for RAG retrieval, it gets cited. Free acquisition channel.
...
- Comparison pages: "[YOUR_PRODUCT] vs [INCUMBENT]" — AI engines love structured comparisons
- "What is X" explainer pages — definition queries trigger RAG retrieval
- Integration guides: "How to use [YOUR_PRODUCT] MCP with Cursor" — procedural queries
...
### GEO quick wins for [YOUR_PRODUCT]

1. Add FAQ schema to landing page and pricing page
2. Create "What is [YOUR_PRODUCT]" / "What is [YOUR_CORE_VALUE_PROP]" explainer pages
3. Add comparison pages (vs [COMPETITOR_A], vs [COMPETITOR_B], vs [COMPETITOR_C])
4. Ensure docs.[your-domain].com pages have clean H1 > H2 > H3 hierarchy
