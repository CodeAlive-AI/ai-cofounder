...
- **signal-scanner** — detects competitor mentions and market signals
- **pipeline-manager** — competitive intel feeds into prospect scoring
- **positioning-workshop** — full positioning exercise with competitive research phase
- **positioning-messaging** — refine messaging based on competitive landscape
- **writing-north-star-metrics** — metrics to track competitive position
- **problem-definition** — define the problem you solve differently
