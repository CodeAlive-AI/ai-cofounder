...
Nikita Bier: "With certainty, if you're good at your job, you can make an app grow and go viral." Develop a library of growth tactics based on platform-specific mechanisms.
...
Uri Levine: "Word-of-mouth you can only have if you have high frequency of use." Sustainable word-of-mouth is tied to how often users engage with the product.
...
- **measuring-product-market-fit**: PMF signals drive loop selection
- **pricing-strategy**: Pricing affects LTV which unlocks paid loops
- **product-led-sales**: PLS is a growth loop type
- **user-onboarding**: Onboarding quality determines loop conversion
- **community-building**: Community is a growth loop amplifier
